...
def clear_history():
    ...
    # 如果檔案存在就清空
    if os.path.exists("chat_history_MeMe.json"):
        with open("chat_history_MeMe.json", "w", encoding="utf-8") as f:
            json.dump([], f, ensure_ascii=False, indent=2)
    
    if os.path.exists("chat_history_Gung.json"):
        with open("chat_history_Gung.json", "w", encoding="utf-8") as f:
            json.dump([], f, ensure_ascii=False, indent=2)
